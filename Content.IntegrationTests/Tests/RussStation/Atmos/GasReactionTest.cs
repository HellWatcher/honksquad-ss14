...
/// return (BZ decomposition).
/// </summary>
/// <remarks>
/// This partial holds the <see cref="TestReaction{T}"/> helper and the simpler
/// single-reaction cases. The proto-nitrate gas chain lives in
/// <c>GasReactionTest.ProtoNitrate.cs</c>, and the
/// <see cref="ReactionHelper.AdjustEnergy"/> cases (which every reaction depends on)
/// live in <c>GasReactionTest.AdjustEnergy.cs</c>.
/// </remarks>
public sealed partial class GasReactionTest : GameTest
{
