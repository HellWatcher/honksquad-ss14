...
// HONK - Upstream removed ActionGun as unused (wizden #43539); the fork's spit
// ability (@RussStation/spit.yml) depends on it, so the fork now owns the system.
// Original upstream namespaces kept so YAML prototypes and ActionGunExtSystem
